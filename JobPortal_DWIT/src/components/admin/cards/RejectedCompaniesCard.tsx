      ...
      <tr key={company._id} className="text-start border capitalize">
        ...
        <td className="px-4 py-2 text-center">
          <div className="flex justify-center space-x-2">
            <button
              className="hover:bg-[#3573A3] border-[#3573A3]
               hover:text-white font-bold py-1   ${
                px-10 text-custom-blue rounded border-2"
              onClick={() => {
                setOpenModal();
              }}
            >
...
export default RejectedCompaniesCard;
