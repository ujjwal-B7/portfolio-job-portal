  ...
  return (
    <>
      <ol className="relative border-s ml-3 border-gray-200 dark:border-gray-700 mt-4">
        <li className="pb-10 ms-6 flex flex-wrap gap-4 items-start justify-between">
          <div>
          ...
          <div className="flex flex-wrap gap-2 mt-1">
            ...
            <button className="inline-flex items-center justify-center w-40 h-10 text-sm font-medium text-white bg-gray-400 border border-gray-200 rounded-lg cursor-text">
              <CircleCheckBig className="size-4 me-2" />
              {role === "company" ? "Accepted" : "Sent"}
            </button>
          </div>
        </li>
