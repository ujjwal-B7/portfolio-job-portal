  ...
  useEffect(() => {
    if (type === "updateJob" && isSingleJobDetailsSuccess && job) {
      const formattedData = {
        ...
        companydescription: job.companyId.description,
  ...
  return (
    <>
      ...
      >
          ...
          <div className="sm:w-[50%] space-y-5">
            <JobInput
              {...register("company", {
                ...
                validate: (value) =>
                  value.trim() !== "" ||
                  "Company cannot be empty or whitespace",
              })}
          ...
          <div className="sm:w-[50%]">
            <textarea
              {...register("companydescription", {
                ...
                validate: (value) =>
                  value.trim() !== "" ||
                  "Company description cannot be empty or whitespace",
              })}
              id="textarea"
              className="border-2 border-[#c7c7c7] rounded-md px-4 py-2 focus:outline-none focus:ring-[0.1px] h-[15rem] focus:ring-custom-blue  mb-1 w-full "
            ...
            {/* <JobInput
              ...
              height="15rem"
              // value={descriptionOfSelectedCompany}
              setValue={setValue(
                "companydescription",
                descriptionOfSelectedCompany
              )}
            /> */}
          </div>
        </div>
        ...
        {/* <div>
          <label htmlFor="applicationStart">ApplicationStart</label>
          <div className="flex sm:flex-row flex-col gap-4">
            <div className="sm:w-[50%]">
              <Controller
                control={control}
                ...
                render={({ field }) => (
                  <DatePicker
                    ...
                    placeholderText="Application Start Date"
                  />
                )}
              />
            </div>
      ...
      {type === "updateJob" ? (
        <div className="flex justify-center lg:mr-5 mt-5">
          <Image
            className="w-56 h-56 rounded-md bg-center object-cover"
            src={`${process.env.NEXT_PUBLIC_API_BASE_URL}/${
              imagePreview
                ? imagePreview
                : job?.companyId?.logo || job?.profileId?.logo
            }`}
            alt={"company-logo"}
            height={224}
            width={224}
        ...
        <div className="flex justify-center lg:mr-5 mt-5">
          {imagePreview ? (
            ...
            // <div className="lg:w-56 md:h-56 rounded-md h-40 w-40 border-[#c7c7c7] bg-[#F8F8F8] border-[3px] flex items-center justify-center ">
            <Image
              className="w-48 h-48 rounded-md bg-center object-cover"
