...
const ProfileCreatePage = () => {
  ...
  return (
    <section className="bg-gray-100 pt-6 ">
      {isProfileLoading && !profile && <div></div>}
      {!isProfileLoading && loggedInUserId && profile && (
        <div className="layout-container  mx-auto px-4 py-10">
          ...
          <div className="mt-10 border border-primary-border rounded-md p-6 bg-white">
            <h1 className="text-xl font-semibold">Personal Information</h1>
            <div className="max-w-[50rem] grid grid-cols-2">
          ...
          <div className="mt-10 border border-primary-border rounded-md p-6 bg-white">
            ...
            {JSON.parse(profile.project_profile)[0].project_title === "" ? (
              <p className="text-sm tracking-wide text-gray-500 pt-4">
                Include information about the projects you&apos;ve worked on
                while in college, during internships, or in your professional
                roles. This will add depth to your profile.
              </p>
            ) : (
              <ul className="space-y-4 divide-y-2">
          ...
          <div className="mt-10 border border-primary-border rounded-md p-6 bg-white">
            ...
            {!profile?.skills ? (
              <p className="text-sm tracking-wide text-gray-500 pt-4">
                ...
                Direct Marketing, Oracle, Java, etc. This will enable us to
                provide you with job opportunities tailored to your skill set.
              </p>
            ) : (
              <ul className="flex gap-3 mt-4 flex-wrap">
